...
if __name__ == "__main__":
    ...
    for file in training_files:
        ...
        for t in range(amount_of_timesteps+1):
            ...
            try:
                ...
                """
                try:
                    prev_angle = df.loc[df["Timestep"]==current_timestep-1]['angle'].values[0]
                except:
                    prev_angle = 0
                x_train_new = np.append(df_t.values.T[2:10].T.flatten(),prev_angle)
                """
                x_train_new = np.append(df_t.values.T[2:10].T.flatten(),current_timestep)
    ...
    for file in test_files:
        ...
        for t in range(amount_of_timesteps+1):
            ...
            try:
                ...
                """
                x_test_new = np.append(df_t.values.T[2:10].T.flatten(),current_timestep)
