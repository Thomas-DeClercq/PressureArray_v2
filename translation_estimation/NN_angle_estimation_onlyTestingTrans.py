...
def pressureReconstruction_df(df,shape,spacing,n=50,m=10,p_m=0.75,iterations=5):
    ...
    for t in range(timesteps):
        ...
        if df.columns.shape[0] == 13:
            ...
            print("amount of columns in dataframe incompatible")
...
if __name__ == "__main__":
    ...
    dnn_model = tf.keras.models.load_model('./NNs/only_trans/NN_1it_100k')
