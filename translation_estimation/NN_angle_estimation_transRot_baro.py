...
def parameters2pressures(df,shape,spacing,n=50,m=10):
    ...
    df_new = np.zeros((timesteps,4+shape[0]*shape[1]))
    ...
    for t in range(timesteps):
        ...
        df_new[t,-2] = df.loc[df['Timestep']==t].values[-1][-2]
        df_new[t,-3] = df.loc[df['Timestep']==t].values[-1][-3]
...
if __name__ == "__main__":
    ...
    if save:
        dnn_model.save(f'./NNs/trans_rot/NN_baro_{int(training_size/1000)}k')
